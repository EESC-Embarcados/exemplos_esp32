...
// Define o pino do LED onboard do ESP32
const int ledPin = 2;
...
{ 
  ...
  // Verifica o estado do botão e acende/apaga o LED onboard do ESP32
  if (RemoteXY.button_1) {
    RemoteXY.led_1_r = 255;
    digitalWrite(ledPin, HIGH);  // Acende o LED onboard
  } else {
    RemoteXY.led_1_r = 0;
    digitalWrite(ledPin, LOW);   // Apaga o LED onboard
  }

  // TODO você código loop
  // use a estrutura RemoteXY para transferência de dados
  // não chame delay()
}
